      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="min-h-[80vh] flex flex-col justify-center space-y-12">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            {/* Left - Description */}
            <div className="lg:text-right text-center space-y-4 order-2 lg:order-1">
            ...
            <div className="flex justify-center order-1 lg:order-2">
              <div className="relative">
                <img
                  ...
                  className="w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80 rounded-full object-cover border-4 border-white/20 shadow-2xl"
                />
